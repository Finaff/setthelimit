...
(function () {
  ...
  function viewMethod() {
    ...
    return shell(`<section class="prose"><h2>${T('How it works')}</h2>
      ...
      <h3>${T('Who made this')}</h3><p>${fmt(T('{site} is an independent project, {stamp}. The propositions, the reviews and the predictions are in the open. Corrections are welcome and are applied with a note.'), { site: SITE, stamp: STAMP })}</p></section>`);
  }
